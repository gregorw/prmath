...
<img src="https://latex.codecogs.com/svg.latex?P=p^{ct}" />

**Majority**

<img src="https://latex.codecogs.com/svg.latex?P=1-\sum_{k=0}^{\lfloor\frac{c}{2}\rfloor}{c\choose\;k}p^{tk}\left(1-p^t\right)^{(c-k)}" />
